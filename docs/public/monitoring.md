...
| SupplementaryServicesCompatibilityAlert | Kafka version out of allowed range in {{`{{ $labels.namespace }}`}}                                    | 3m  | high     | `kafka_server_app_info_Version{namespace="{{ .Release.Namespace }}"}) and on(kafka_server_app_info_Version{namespace="{{ .Release.Namespace }}", version!~"^(3\\.[0-9]+\\.[0-9]+4\\.[0-9]\\.[0-9])$"} > 0`                                                  | Kafka supplementary services in namespace {{ $labels.namespace }} is not compatible with Kafka version {{ $labels.application_version }} | [SupplementaryServicesCompatibilityAlert](/docs/public/alerts.md#supplementaryservicescompatibilityalert) | Supported     | Supported     |
